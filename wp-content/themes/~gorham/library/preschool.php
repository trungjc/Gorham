 ...
 * Used in header.php
 */
if ( ! ( function_exists( 'gorham_schema' ) ) ):

function gorham_schema() {
    ...
    $args['fields'] = array(
        'author' => '
            <div class="comment-form-author form-group">
              <label for="author" class="screen-reader-text">' . __('Author', 'gorham') . '</label>
        ...
        'email' => '
            <div class="comment-form-email form-group">
              <label for="email" class="screen-reader-text">' . __('Email', 'gorham') . '</label>
        ...
        'url' => '
            <div class="comment-form-url last form-group">
              <label for="url" class="screen-reader-text">' . __('Website', 'gorham') . '</label>
...
function gorham_paginate($args = null) {
  ...
  $paginate_links = paginate_links( array(
    ...
    'mid_size' => 2,
    'prev_next' => True,
    'prev_text' => __('&laquo;', 'gorham'),
    'next_text' => __('&raquo;', 'gorham'),
 ...
 */
if ( ! function_exists( 'gorham_more_link' ) ) :
function gorham_more_link( $link, $link_button ) {

    return str_replace( $link_button, '<p><a href="' . get_permalink() . '" class="readmore btn btn-sm btn-primary " title="Read More">' . __( 'Read More', 'gorham' ) . ' </a> </p>', $link );
}
add_filter( 'the_content_more_link', 'gorham_more_link', 10, 2 );

endif; // end gorham_more_link
